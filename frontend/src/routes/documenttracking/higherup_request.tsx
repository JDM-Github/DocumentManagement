...
export default function HigherUpRequest({
    title,
    status,
    renderActions,
    toggleRefresh,
    ...
    const fetchRequests = async (status: string, showT: boolean = true) => {
        ...
        const res = await RequestHandler.fetchData(
            "GET",
            `request-letter/higherups/${status}`,
            {},
        );
        ...
        <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                ...
                <div>
                    ...
                    <span className="ml-2 font-medium">{row.lastDepartmentId}</span>
                </div>
                <div>
        ...
        >
            ...
            >
                ...
                <p className="text-base text-slate-600">
                    Review and manage incoming requests requiring higher-level approval.
                </p>
            </motion.div>
